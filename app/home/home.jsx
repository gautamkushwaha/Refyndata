      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-3/5 mx-3 mb-8 md:mb-0 md:mr-4">
          ...
          <div className="md:hidden mb-4">
            <Image width={224} height={224} src="home_image/RefyndataHero.svg" alt="Image" className="w-56 md:w-full mx-auto" />
          </div>
        ...
        <div className="md:w-2/5 hidden md:block">
          <Image width={538} height={601} src="home_image/RefyndataHero.svg" alt="refyndata"  />
        </div>
      </div>
    </div>
